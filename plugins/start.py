...
async def send_doc(client,message):
       ...
       if update_channel :
       	try:
       		...
       		await message.reply_text("**__You are not subscribed my channel__** ",reply_to_message_id = message.message_id, reply_markup = InlineKeyboardMarkup([ [ InlineKeyboardButton("Channel" ,url=f"https://t.me/{update_channel}") ]   ]))
       		return
       date = message.date
